...
if not "%1"=="" goto :g
	echo Example for doubling speed: ffspd filename 0.5
	echo Example for quadrouple a set of files: ffspd all *.mp4 0.25
	goto :eof
...
echo -------------------------
echo %output%.spd.mp4 is ready
goto :eof

:loop
for %%f in (%2) do call ffspd %%f %3
